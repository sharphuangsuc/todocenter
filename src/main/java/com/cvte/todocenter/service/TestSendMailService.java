...
public class TestSendMailService {
    ...
    //发件人的邮箱和密码
    public static String myEmailAccount="1136132575@qq.com";
    public static String myEmailPassword = "fbssvihnsquthbig";
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "944745562@qq.com";
